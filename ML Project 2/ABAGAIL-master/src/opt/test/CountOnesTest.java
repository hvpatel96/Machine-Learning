...
public class CountOnesTest {
    ...
    public static void main(String[] args) {
        ArrayList<Double> RHC = new ArrayList<>();
        ...
        for (int i = 0; i < 50; i++) {
            ...
            System.out.println(rhc.getOptimal());
            RHC.add(ef.value(rhc.getOptimal()));

            SimulatedAnnealing sa = new SimulatedAnnealing(100, .95, hcp);
            fit = new FixedIterationTrainer(sa, 500);
            fit.train();
            System.out.println(ef.value(sa.getOptimal()));
            SA.add(ef.value(sa.getOptimal()));

            StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(20, 20, 0, gap);
            fit = new FixedIterationTrainer(ga, 500);
            fit.train();
            System.out.println(ef.value(ga.getOptimal()));
            GA.add(ef.value(ga.getOptimal()));
