...
def model_crossover(model_idx1, model_idx2):
    ...
    weightsnew1[0][2] = weights2[0][2]
    weightsnew2[0][2] = weights1[0][2]
    weightsnew1[0][0] = weights2[0][0]
    weightsnew2[0][0] = weights1[0][0]
...
def showGameOverScreen(crashInfo):
    ...
    print("Average Fitness: " + str(total_fitness/total_models))
    print("Score: " + str(crashInfo['score']))
    for select in range(total_models):
